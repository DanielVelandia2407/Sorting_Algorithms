...
public class InsertionDoubleListView extends JFrame {
    ...
    public InsertionDoubleListView() {
        // Basic window configuration
        setTitle("Insertion Sort - Lista Doble");
        setSize(900, 980);
        ...
        JLabel lblTitle = new JLabel("Insertion Sort - Lista Doble");
        ...
        // Info sobre estructura doble
        lblStructureInfo = new JLabel("Nota: Lista con enlaces previos y siguientes");
        ...
        btnSort = createStyledButton("Ordenar (Insertion Sort Doble)", new Color(41, 128, 185));
        ...
        JLabel lblInfo = new JLabel("© 2025 - APOCO Sorting Algorithms v1.0 - Lista Doble");
