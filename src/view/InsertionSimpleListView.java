...
public class InsertionSimpleListView extends JFrame {
    ...
    public InsertionSimpleListView() {
        // Basic window configuration
        setTitle("Insertion Sort - Lista Simple");
        setSize(900, 950);
        ...
        JLabel lblTitle = new JLabel("Insertion Sort - Lista Simple");
        ...
        btnSort = createStyledButton("Ordenar (Insertion Sort)", new Color(41, 128, 185));
