...
public class InsertionSimpleCircularView extends JFrame {
    ...
    public InsertionSimpleCircularView() {
        // Basic window configuration
        setTitle("Insertion Sort - Lista Simple Circular");
        setSize(900, 980);
        ...
        JLabel lblTitle = new JLabel("Insertion Sort - Lista Simple Circular");
        lblTitle.setFont(new Font("Segoe UI", Font.BOLD, 22));
        lblTitle.setForeground(Color.WHITE);
        lblTitle.setAlignmentX(Component.CENTER_ALIGNMENT);

        JLabel lblSubtitle = new JLabel("Organizando políticos corruptos en una lista circular");
        lblSubtitle.setFont(new Font("Segoe UI", Font.ITALIC, 14));
        lblSubtitle.setForeground(new Color(240, 248, 255));
        lblSubtitle.setAlignmentX(Component.CENTER_ALIGNMENT);

        // Info sobre estructura circular
        lblStructureInfo = new JLabel("Nota: Lista circular donde el último nodo apunta al primero");
        ...
        // Center align money values and next pointer
        ...
        btnSort = createStyledButton("Ordenar (Insertion Sort Circular)", new Color(41, 128, 185));
        ...
        JLabel lblInfo = new JLabel("© 2025 - APOCO Sorting Algorithms v1.0 - Lista Circular");
