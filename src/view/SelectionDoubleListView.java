...
public class SelectionDoubleListView extends JFrame {
    ...
    public SelectionDoubleListView() {
        // Basic window configuration
        setTitle("Selection Sort - Lista Doble");
        setSize(900, 950);
        ...
        JLabel lblTitle = new JLabel("Selection Sort - Lista Doble");
        lblTitle.setFont(new Font("Segoe UI", Font.BOLD, 22));
        lblTitle.setForeground(Color.WHITE);
        lblTitle.setAlignmentX(Component.CENTER_ALIGNMENT);

        JLabel lblSubtitle = new JLabel("Organizando políticos corruptos con navegación bidireccional");
