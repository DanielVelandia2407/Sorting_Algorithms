...
public class SelectionSimpleListView extends JFrame {
    ...
    public SelectionSimpleListView() {
        // Basic window configuration
        setTitle("Selection Sort - Lista Simple");
        setSize(900, 950);
        ...
        JLabel lblTitle = new JLabel("Selection Sort - Lista Simple");
        lblTitle.setFont(new Font("Segoe UI", Font.BOLD, 22));
        lblTitle.setForeground(Color.WHITE);
        lblTitle.setAlignmentX(Component.CENTER_ALIGNMENT);

        JLabel lblSubtitle = new JLabel("Organizando políticos corruptos por cantidad de dinero a robar");
        ...
        tableModel = new DefaultTableModel(new Object[]{"ID", "Nombre", "Dinero a Robar ($)"}, 0) {
            @Override
